...
namespace Services.ShoppingCartAPI.Controllers
{
    ...
    [ApiController]
    public class ShoppingCartAPIController_MessageBus : ControllerBase
    {
        ...
        public ShoppingCartAPIController_MessageBus(AppDbContext context, IMapper mapper, IProductService productService,
